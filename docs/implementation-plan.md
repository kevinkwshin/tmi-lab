# Website delivery and maintenance

1. Verify professional profile, publication metadata, and patent-family records against the cited sources.
2. Keep Korean and English copy synchronized, use the original logo and reviewed research imagery, and feature NeuroCAD in the technology-transfer section.
3. Run the production build and check responsive layouts, navigation, filters, language switching, and reduced-motion behavior in a real browser.
