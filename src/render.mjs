...
<section class="section translation-section" id="translation"><div class="container">
...
<section class="section container mission-story" id="mission">
...
<section class="section" id="publications"><div class="container">
...
<section class="section patents-section" id="patents"><div class="container"><div class="section-heading"><div><p class="eyebrow">05 / PATENTS</p><h2>${ko ? '특허' : 'Patents & applications'}</h2></div></div><div class="patent-list">${patents.filter(p=>p.area==='medical').map(patentRow).join('')}<details class="details"><summary>${ko ? '이전 산업 연구 특허' : 'Earlier industrial research patents'}</summary>${patents.filter(p=>p.area==='industry').map(patentRow).join('')}</details></div></div></section>
<section class="section people-section" id="people"><div class="container">
${heading(c.people)}
