export const content = {
  ko: {
    ...
    hero: {
      ...
      titleLines: ['TMI-lab'],
      description: 'TMI-lab은 실제 임상 문제를 해결하기 위해 의료진의 판단과 워크플로우 개선을 돕는 AI를 연구하고 구현합니다.',
      primary: '기술이전 사례', secondary: '연구 살펴보기',
      caption: '의료영상의 해부학적 구조를 이해하고 정량화하는 연구',
    },
    intro: {
      label: '02 / OUR MISSION', title: '정보를 지능으로,\n연구를 임상으로.',
      body: '임상 문제의 정의부터 데이터·모델 설계, 사용 환경에 맞는 평가까지. 기술의 가능성을 실제 의료의 쓰임으로 연결합니다.',
    },
    approach: {
      label: 'OUR APPROACH', title: '문제 정의부터 적용을 위한 평가까지',
      steps: [
        { title: '임상 문제를 구체화합니다', body: '의료진과 함께 반복되는 측정, 판독, 정보 정리 업무에서 연구 질문을 찾습니다.' },
        { title: '데이터와 방법을 연결합니다', body: '영상, 텍스트, 생체신호의 특성을 이해하고 문제에 맞는 AI 방법을 설계합니다.' },
        { title: '실제 사용 조건을 평가합니다', body: '성능과 오류를 살피고, 새로운 데이터와 임상 업무에서의 유용성을 검증합니다.' },
      ],
    },
    research: {
      label: '03 / RESEARCH', title: '서로 다른 데이터,\n하나의 임상 질문.',
    ...
    translation: {
      label: '01 / TRANSLATION', title: '연구에서 시작해,\n기술이전으로.',
      intro: '',
      items: [
    ...
    publications: {
      label: '04 / SELECTED PUBLICATIONS', title: '논문',
      intro: '',
    ...
    people: {
      label: '06 / PEOPLE', title: '구성원 소개', name: '신기원', role: '조교수 · PhD',
    ...
    contact: {
      label: '07 / CONTACT', title: '연구 협력 및 문의',
  ...
  en: {
    ...
    intro: {
      label: '02 / OUR MISSION', title: 'From information\nto intelligence.',
      body: 'We connect the stages of translation: defining a clinical question, designing data and models, and evaluating them in the context of their intended use.',
    },
    approach: {
      ...
      steps: [
        ...
        { title: 'Evaluate for real use', body: 'Examine performance and errors, and assess utility on new data and within clinical workflows.' },
      ],
    },
    research: {
      label: '03 / RESEARCH', title: 'Different data.\nA shared clinical question.',
    ...
    translation: {
      label: '01 / TRANSLATION', title: 'Research translated\ninto technology.',
      intro: '',
      items: [
    ...
    publications: {
      label: '04 / SELECTED PUBLICATIONS', title: 'Publications',
      intro: '',
    ...
    people: {
      label: '06 / PEOPLE', title: 'People', name: 'Keewon Shin', role: 'Assistant Professor · PhD',
    ...
    contact: {
      label: '07 / CONTACT', title: 'Research collaboration\n& inquiries',
